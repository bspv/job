package com.bazzi.job.manager.aspect;

import com.bazzi.job.common.annotation.GroupCfg;
import com.bazzi.job.common.annotation.ValidCfg;
import com.bazzi.job.common.ex.ParameterException;
import com.bazzi.job.common.generic.StatusCode;
import com.bazzi.job.common.util.AspectUtil;
...
public class ValidatorAspect {
    ...
    @Before(value = "execution(public * com.bazzi.job.manager.controller.*.*(..)) " +
            "|| execution(public * com.bazzi.job.manager.controller.*.*.*(..))")
...
//            msg = msg.replaceAll(";", "和");
            log.debug(msg);
            throw new ParameterException(StatusCode.CODE_002.getCode(), msg);
        }
    }
